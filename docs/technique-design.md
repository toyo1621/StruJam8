...
This gives every target at least one concrete route and every intent at least one concrete route. The current catalog contains 37 concrete routes and 296 techniques.
