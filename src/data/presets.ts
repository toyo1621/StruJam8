...
const indietronicaTrackPatterns = {
  drums:
    'stack(s("sbd ~ [sbd sbd] ~").gain(0.72), s("~ pink ~ pink ~").decay(0.052).hpf(4500).gain(0.25), s("white*4").decay(0.028).hpf(6000).gain(0.18), s("white*16").decay(0.022).hpf(8800).gain(0.12))',
